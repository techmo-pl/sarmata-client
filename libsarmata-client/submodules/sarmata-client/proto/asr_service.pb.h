...
#ifndef PROTOBUF_submodules_2fsarmata_2dclient_2fproto_2fasr_5fservice_2eproto__INCLUDED
#define PROTOBUF_submodules_2fsarmata_2dclient_2fproto_2fasr_5fservice_2eproto__INCLUDED
...
class RecognizeRequest : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_submodules_2fsarmata_2dclient_2fproto_2fasr_5fservice_2eproto();
  friend void protobuf_AssignDesc_submodules_2fsarmata_2dclient_2fproto_2fasr_5fservice_2eproto();
  friend void protobuf_ShutdownFile_submodules_2fsarmata_2dclient_2fproto_2fasr_5fservice_2eproto();
...
// optional bool ok = 2;
inline void DefineGrammarRespone::clear_ok() {
  ok_ = false;
}
inline bool DefineGrammarRespone::ok() const {
  // @@protoc_insertion_point(field_get:sarmata.DefineGrammarRespone.ok)
  return ok_;
}
inline void DefineGrammarRespone::set_ok(bool value) {
...
#endif  // PROTOBUF_submodules_2fsarmata_2dclient_2fproto_2fasr_5fservice_2eproto__INCLUDED
