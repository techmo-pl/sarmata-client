...
_DEFINEGRAMMARRESPONSE = _descriptor.Descriptor(
  ...
  full_name='sarmata.DefineGrammarResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='sarmata.DefineGrammarResponse.status', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='error', full_name='sarmata.DefineGrammarResponse.error', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='ok', full_name='sarmata.DefineGrammarResponse.ok', index=2,
...
_ASR = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Recognize',
    full_name='sarmata.ASR.Recognize',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='DefineGrammar',
    full_name='sarmata.ASR.DefineGrammar',
    index=1,
    containing_service=None,
